<template>
  <div class="space-y-4">
    <div class="page-head">
      <div>
        <h1 class="page-title no-wrap">邀请推广</h1>
        <p class="page-subtitle">邀请新商户注册，获得返现奖励</p>
      </div>
    </div>

    <div class="card">
      <div class="card-body">
        <h3 class="text-lg font-semibold text-gray-900 mb-4 no-wrap">我的推广链接</h3>
    ...
    <div class="card">
      <div class="card-body">
        <h3 class="text-lg font-semibold text-gray-900 mb-4 no-wrap">返现规则</h3>
    ...
    <div class="table-shell">
      <div class="card-header">
        <h3 class="text-lg font-semibold text-gray-900 no-wrap">邀请记录</h3>
      </div>
        ...
        <table class="table min-w-[860px] whitespace-nowrap">
          <thead>
            <tr>
              ...
              <th class="text-right">返现金额</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="record in records" :key="record.id">
              <td class="text-left">{{ record.uid }}</td>
              <td class="text-left text-gray-500">{{ formatTime(record.addtime) }}</td>
              <td class="text-right text-green-600 font-medium">+￥{{ record.money }}</td>
            </tr>
